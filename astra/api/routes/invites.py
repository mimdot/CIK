...
def invites_required() -> bool:
    ...
    Controlled by ``ASTRA_INVITE_REQUIRED`` (:func:`api.routes.auth.register`),
    ...
    the private-beta gate with ``ASTRA_INVITE_REQUIRED=1``.
    """
    for name in ("ASTRA_INVITE_REQUIRED", "INVITES_REQUIRED"):
