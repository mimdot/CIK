...
from the ``ASTRA_SECRET_KEY`` environment variable with a dev fallback (overriden
...
SECRET_KEY = os.environ.get("ASTRA_SECRET_KEY", "")
if not SECRET_KEY:
    import warnings
    warnings.warn(
        "ASTRA_SECRET_KEY not set — tokens are signed with an insecure "
