...
3. Run `python astra.py --field <yourfield> --limit-per-source 30`
...
6. Test: `python astra.py --source my_board --debug`.
...
* **Self-test must pass**: `python astra.py --self-test` before and
